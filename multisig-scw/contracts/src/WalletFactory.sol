...
contract WalletFactory {
    ...
    /**
     * function returns the counterfactual address for a to-be-deployed transaction contract.
    ...
    function getAddress(
        ...
        bytes memory proxyConstructor = abi.encode(
            address(walletImplementation.getProxyConstructor),
            walletInit
        );
